...
import ClubElement from './ClubElementP7MC.js';
import {CartArrayContext} from '../../CartArrayContext.js';

function P7MC() {

    const [mainImage, setMainImage] = useState("https://www.taylormadegolf.com/on/demandware.static/-/Sites-tmag-master-catalog/en_US/v1599839871089/zoom/TA156_zoom_D.jpg");
    ...
    function addToCart() {
        setCartArray([...cartArray, {clubImage: "https://www.taylormadegolf.com/on/demandware.static/-/Sites-tmag-master-catalog/en_US/v1599839871089/zoom/TA156_zoom_D.jpg", clubName: "P7MC", clubSet: clubSet, clubGrip: grip, clubShaft: shaft, clubLieAngle: lieAngle}]);
            ...
            <div className="displayBox">
                ...
                <div className="clubImagesWrapper">
                    <div className="clubImages">
                        <img className="smallClubImage" alt="p7MC" onClick={pictureSelect} src="https://www.taylormadegolf.com/on/demandware.static/-/Sites-tmag-master-catalog/en_US/v1599839871089/zoom/TA156_zoom_D.jpg"></img>
                        <img className="smallClubImage" alt="p7MC" onClick={pictureSelect} src="https://www.taylormadegolf.com/on/demandware.static/-/Sites-tmag-master-catalog/en_US/v1599839871089/zoom/TA156_zoom_D2.jpg"></img>
                        <img className="smallClubImage" alt="p7MC" onClick={pictureSelect} src="https://www.taylormadegolf.com/on/demandware.static/-/Sites-tmag-master-catalog/en_US/v1599839871089/zoom/TA156_zoom_D3.jpg"></img>
                        <img className="smallClubImage" alt="p7MC" onClick={pictureSelect} src="https://www.taylormadegolf.com/on/demandware.static/-/Sites-tmag-master-catalog/en_US/v1599839871089/zoom/TA156_zoom_D4.jpg"></img>
                        <img className="smallClubImage" alt="p7MC" onClick={pictureSelect} src="https://www.taylormadegolf.com/on/demandware.static/-/Sites-tmag-master-catalog/en_US/v1599839871089/zoom/TA156_zoom_D5.jpg"></img>
                    </div>
                </div>
                <div className="selectedImage">
                    <img className="mainImage" alt="p7MC" src={mainImage} />
                </div>
                </div>
                        ...
                        <div className="boxOneInformationWrapper">
                            <div className="boxOneInformation">
                                <div className="writtenWrapper">
                                    <div className="writtenWrapperH1"><h1>P7MC Irons</h1></div>
